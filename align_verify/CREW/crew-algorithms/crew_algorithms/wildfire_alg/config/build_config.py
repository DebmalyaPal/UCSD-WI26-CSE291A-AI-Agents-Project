...
def create_level_presets():
    ...
    presets['Suppress_Fire_Extinguish'] = {
        'game_type': 3, 'map_size': 30, 'water': True, 'fire_spread_frequency': 200,
        'starting_firefighter_agents': 5, 'vegetation_density_offset': 60, 'known': True,
    }
    
    # Rescue Civilians: Search and Rescue
    presets['Rescue_Civilians_Search_and_Rescue'] = {
        'game_type': 4, 'map_size': 50, 'civilian_count': 5, 'civilian_clusters': 1, 'civilian_move_frequency': 300,
        'starting_firefighter_agents': 5, 'known': False,
    }
    
    # Suppress Fire: Locate and Suppress
    presets['Suppress_Fire_Locate_and_Suppress'] = {
        'game_type': 3, 'map_size': 50, 'water': False, 'fire_spread_frequency': 500,
        'starting_firefighter_agents': 5, 'starting_bulldozer_agents': 1, 'vegetation_density_offset': 30, 'known': False,
    }
