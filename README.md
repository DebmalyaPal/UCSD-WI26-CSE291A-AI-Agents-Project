# UCSD-WI26-CSE291A-AI-Agents-Project
Agentic-Resilience - Benchmarking Multi-Agent Systems in High-Stress Disaster Simulations
...
2) Install Go [OPTIONAL - if not using Docker route]
```bash
brew install go
```
...
3) Install Go (Windows installer) [OPTIONAL - if not using Docker route]  
https://go.dev/dl/
...
------------------------------------------------------------
```bash
git clone https://github.com/DebmalyaPal/UCSD-WI26-CSE291A-AI-Agents-Project
cd UCSD-WI26-CSE291A-AI-Agents-Project
```
...
This project uses code from the CREW (Collaborative Robotics Environment for Wildfire) repository:

- Repository: https://github.com/generalroboticslab/CREW
- License: Apache License 2.0
- Original authors: General Robotics Lab
- CREW code is included as a git submodule in `external/CREW`
